...
export default function PannelCreate() {
  ...
  <div className="grid md:grid-cols-2 gap-4">
    <div>
      <div className="mb-4">
        <label className="block text-sm font-bold mb-2">Pannel Name:</label>
        <input
          type="text"
          name="pannelName"
      ...
      <div className="mb-4">
        <label className="block text-sm font-bold mb-2">Pannel Members 1:</label>
        <select
          name="pannelMember1"
      ...
      <div className='mb-4'>
      <label className="block text-sm font-bold mb-2">Select Group:</label>
      <select
        name='GroupID'
        value={formData.id}
          className="shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline"
    ...
    <div>
      <div className="mb-4">
        <label className="block text-sm font-bold mb-2">Pannel Members 2:</label>
        <select
          name="pannelMember2"
      ...
      <div className="mb-4">
        <label className="block text-sm font-bold mb-2">Pannel Members 3:</label>
        <select
          name="pannelMember3"
